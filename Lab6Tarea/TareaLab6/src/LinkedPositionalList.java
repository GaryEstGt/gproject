	  ...
	  private static class Node<E> implements Position<E> {
		...
		private Position<E> addBetween(E e, Node<E> pred, Node<E> succ) {
	            ...
	            if(size>1){
	                ...
	                p1=header.getNext().getNext();
	                p2=trailer.getPrev().getPrev();
	                p3=trailer.getPrev().getPrev();
		...
		public Position<E> search(E value){
			if(isEmpty()==true) {
				...
				Node<E> nodo=trailer.getPrev();
				Node<E> retorna=null;
				  while(nodo!=null) {
					  if(nodo.getElement()==value) {
						  retorna=nodo;
						  nodo=null;
					  }
					  else {
		...
		public Position<E> addBeforeB(Position<E> p, PositionalList<E> sublist){
		
			
			return sublist.addBefore(p,validate(p).getElement()); 
			
		}
		public Position<E> addAfterB(Position<E> p, PositionalList<E> sublist){
		
			
			return sublist.addAfter(p,validate(p).getElement()); 
			
		}
		public Position<E> addFirstB(Position<E> p, PositionalList<E> sublist){
		
			
			return sublist.addFirst(validate(p).getElement()); 
			
		}
	public Position<E> addLastB(Position<E> p, PositionalList<E> sublist){
		
			
			return sublist.addLast(validate(p).getElement()); 
			
		}
	public int distance(Position<E> a,Position<E> b) {
		Node<E> nodo=validate(a);
		Node<E> nodo2=validate(b);
		int tamanio=1;
		while(nodo!=null) {
			if(nodo==nodo2) {
				nodo=null;
